...
* [prusa-slic3r](https://www.prusa3d.com). This is the slicer software for 3D printers from the manufacturer Prusa. This program is used to convert the STL files to printer specific gcode files.
